                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="{{$profileData->user_image}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                <div class="mt-3">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <img src="{{$profileData->user_image}}" id="showImage" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                            </div>
                            </div>
                            <div class="row">
