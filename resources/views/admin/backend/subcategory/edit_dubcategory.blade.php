    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit SubCategorye</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-body p-4">
                <h5 class="mb-4">Edit {{ $subcategory->category_name }}</h5>
                <form id="myForm" class="row g-3" method="POST"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="input1" placeholder="Category Name"
                            name="category_name" value="{{ $subcategory->category_name }}">
                        @error('category_name')
                    ...
                    <div class="col-md-6">
                        <img id="showImage" src="{{ asset($subcategory->image) }}" alt="" class=" p-1 "
                            width="200">
                    </div>
