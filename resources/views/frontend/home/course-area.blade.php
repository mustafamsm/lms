        ...
        <div class="card card-item">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                     <button type="submit" class="btn theme-btn flex-grow-1 mr-3" onclick="addToCart({{ $course->id }}, '{{ $course->course_name }}', {{ $course->instructor_id }}, '{{ $course->course_name_slug }}')"><i class="la la-shopping-cart mr-1 fs-18"></i> Add to Cart</button>
