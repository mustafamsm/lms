                    ...
                    <div class="category-item">
                        ...
                        <div class="category-content">
                            <div class="category-inner">
                                <h3 class="cat__title"><a href="{{route('category.details',$category->category_slug)}}">{{$category->category_name}}</a></h3>
                                <p class="cat__meta">{{ $category->courses->count() > 0 ? $category->courses->count() . ' courses' : 'No courses available' }}</p>
                                <a href="{{route('category.details',$category->category_slug)}}" class="btn theme-btn theme-btn-sm theme-btn-white">Explore<i class="la la-arrow-right icon ml-1"></i></a>
                            </div>
