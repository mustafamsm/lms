            ...
            <div class="col-lg-8 mr-auto">
                <div class="breadcrumb-content">
                    <ul class="generic-list-item generic-list-item-arrow d-flex flex-wrap align-items-center">
                        ...
                        <li><a href="#">{{ $course->subcategory->category_name }}</a></li>
                    </ul>
                    ...
                    <div class="course-details-content-wrap pt-90px">
                        ...
                        <div class="course-overview-card border border-gray p-4 rounded">
                            ...
                            <div class="pb-3">
                                <img width="85" class="mr-3" src="{{ asset('frontend/images/sponsor-img.png') }}"
                                    alt="company logo">
                                <img width="80" class="mr-3" src="{{ asset('frontend/images/sponsor-img2.pn') }}g"
                                    alt="company logo">
                                <img width="80" class="mr-3" src="{{ asset('frontend/images/sponsor-img3.pn') }}g"
                                    alt="company logo">
                                <img width="70" class="mr-3" src="{{ asset('frontend/images/sponsor-img4.pn') }}g"
                                    alt="company logo">
                            </div>
                        ...
                        <div class="course-overview-card">
                            ...
                            <div class="collapse" id="collapseMore">
                                <h3 class="fs-24 font-weght-semi-bold py-2">who this course is for:</h3>
                        ...
                        <div class="course-overview-card">
                            ...
                            <div class="curriculum-content">
                                <div id="accordion" class="generic-accordion">
                                    @foreach ($course->sections()->with('lectures')->get() as $section)
                                        <div class="card">
                                ...
                                <div class="media media-card">
                                    <div class="instructor-img">
                                        <a href="teacher-detail.html" class="media-img d-block">
                                            <img class="lazy" src="{{ $course->user->user_image }}"
                                                data-src="{{ $course->user->user_image }}" alt="Avatar image">
                                        </a>
                                        <ul class="generic-list-item pt-3">
                                            ...
                                            <li><i class="la la-play-circle-o mr-2 text-color-3"></i>
                                                {{ $course->user->courses()->count() }} Courses</li>
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="d-block lh-18 pt-2 pb-3">Joined
                                            {{ $course->user->created_at->diffForHumans() }}</span>
                                ...
                                <div class="preview-course-feature-content pt-40px">
                                    <p class="d-flex align-items-center pb-2">
                                        <span class="fs-35 font-weight-semi-bold text-black">
                                            ${{ number_format($course->discount_price ?? $course->selling_price, 2) }}
                                        </span>
                                        @if($course->discount_price)
                                            ...
                                            <span class="price-discount">
                                                {{ round((($course->selling_price - $course->discount_price) / $course->selling_price) * 100) }}% off
                                            </span>
                                        @endif
                                    </p>
                        ...
                        <div class="card card-item">
                            <div class="card-body">
                                ...
                                <ul class="generic-list-item generic-list-item-flash">
                                    ...
                                    <li class="d-flex align-items-center justify-content-between"><span><i
                                                class="la la-play-circle-o mr-2 text-color"></i>Lectures</span> {{$course->lectures()->count()}}</li>
                                    <li class="d-flex align-items-center justify-content-between"><span><i
                            ...
                            <div class="card-body">
                                ...
                                @foreach($relatedCourses as $related)
                                    <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                        ...
                                        <div class="media-body">
                                            <h5 class="fs-15">
                                                <a href="{{ url('course/details/' . $related->id . '/' . $related->course_name_slug) }} ">{{ $related->course_name }}</a>
                                            </h5>
                                            <span class="d-block lh-18 py-1 fs-14">{{ $related->user->name }}</span>
                                            <p class="text-black font-weight-semi-bold lh-18 fs-15">
                                                ${{ number_format($related->discount_price ?? $related->selling_price, 2) }}
                                                @if($related->discount_price)
                                                    <span class="before-price fs-14">${{ number_format($related->selling_price, 2) }}</span>
                                                @endif
                                            </p>
                                        </div>
                                    </div>
        ...
        <div class="container">
            <div class="related-course-wrap">
                ...
                <div class="view-more-carousel-2 owl-action-styled">
                    @foreach ($course->user->courses()->limit(3)->get() as $cr)
                        <x-course-card :course="$cr"/>
                    @endforeach
