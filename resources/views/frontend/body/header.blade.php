                ...
                <div class="col-lg-6">
                    <div class="header-widget d-flex flex-wrap align-items-center justify-content-end">
                        ...
                        <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14 border-left border-left-gray pl-3 ml-3">
                            ...
                            <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i class="la la-user mr-1"></i><a href="{{route('dashboard')}}"> {{ Auth::user()->name }}</a></li>
                            <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i class="la la-sign-out mr-1"></i><a href="{{route('user.logout')}}"> Logout</a></li>
                            @else
                            <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i class="la la-user mr-1"></i><a href="{{route('admin.dashboard')}}"> {{ Auth::user()->name }}</a></li>
                            <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i class="la la-sign-out mr-1"></i><a href="{{route('admin.logout')}}"> Logout</a></li>
                        @endif
