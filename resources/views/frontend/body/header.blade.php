                        ...
                        <ul
                            ...
                            @auth
                                @if (Auth::user()->role !== 'admin')
                                    <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i
                                            class="la la-user mr-1"></i><a href="{{ route('dashboard') }}">
                                            {{ Auth::user()->name }}</a></li>
                                    <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i
                                            class="la la-sign-out mr-1"></i><a href="{{ route('user.logout') }}"> Logout</a>
                                    </li>
                                @else
                                    <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i
                                            class="la la-user mr-1"></i><a href="{{ route('admin.dashboard') }}">
                                            {{ Auth::user()->name }}</a></li>
                                    <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i
                                            class="la la-sign-out mr-1"></i><a href="{{ route('admin.logout') }}">
                                            Logout</a></li>
                                @endif
                            @else
                                <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i
        ...
        <div class="container-fluid">
            <div class="main-menu-content">
                ...
                <div class="row align-items-center">
                    ...
                    @php
                        $categoires = App\Models\Category::with('subcategories')
